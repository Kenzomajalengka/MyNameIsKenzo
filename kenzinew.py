...
def banner():
	os.system('clear')
	baz_bann(f'''{mer}  _  _______ _   _ ________   __  ______
{mer} | |/ / ____| \ | |__  / _ \  \ \/ /  _ \

{mer} | ' /|  _| |  \| | / / | | |  \  /| | | |
{puti} | . \| |___| |\  |/ /| |_| |  /  \| |_| |
{puti} |_|\_\_____|_| \_/____\___/  /_/\_\____/    
{hijo} KenzoXD Versi New Maaf Jika Jarang Ok Karna Sc Free
Whatsapp: 083878729914''')
...
def menu(id):
	try:
		...
		login_men()
	os.system('clear')
	os.system('xdg-open https://chat.whatsapp.com/BnSIYyVyoy95p6NJtvOdkK')
	waktu(1)
	banner()
	print(f'{xxx}─────────────────────────────')
